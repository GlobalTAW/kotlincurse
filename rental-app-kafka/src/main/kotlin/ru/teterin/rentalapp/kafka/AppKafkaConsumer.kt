...
interface ConsumerStrategy {
    ...
    fun serialize(source: RentalContext): String
    fun deserialize(value: String, target: RentalContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: RentalAdProcessor = RentalAdProcessor(),
    ...
    private fun sendResponse(context: RentalContext, strategy: ConsumerStrategy, outputTopic: String) {
    ...
    private data class TopicsAndStrategy(val inputTopic: String, val outputTopics: String, val strategy: ConsumerStrategy)
